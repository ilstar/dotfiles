= Fred's Dot Files from Ryan Bates
...
== Installation
  ...
  git clone git://github.com/ilstar/dotfiles ~/.dotfiles
  cd ~/.dotfiles
  rake install

== NOTE

I'm only running on Mac OS X, so I'm not sure this is works for others OS.
